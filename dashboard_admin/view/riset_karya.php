...
// Ambil data riset
if ($filter_dosen !== "") {
  $result = getRisetByDosen($conn, $filter_dosen); // pastikan fungsi ini ada
} else {
  $result = getAllRiset($conn);
}
?>
...
<body>
  ...
  <div id="content" class="content">
    <div class="container-fluid p-3">
      ...
      <!-- JUDUL PAGE -->
      <h4 class="fw-bold mb-4 text">Manajemen Riset / Penelitian</h4>

      <!-- TAMBAH RISET -->
      <div class="card shadow-sm p-4 mb-5">
        <h5 class="fw-bold mb-3">Tambah Riset Baru</h5>

        <form action="../controller/add_riset_action.php" method="POST">
          <div class="row g-3">

            <div class="col-md-4">
              <label class="form-label">Member Dosen</label>
          ...
          <div class="text-end mt-4">
            <button type="submit" class="btn btn-primary">
              <i class="bi bi-plus-lg"></i> Tambah Riset
            </button>
          </div>
        </form>
      </div>
      ...
      <!-- FILTER RISET -->
      <h4 class="fw-bold mb-4 text">Daftar Riset</h4>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-sm btn-danger"
                          href="../controller/riset_delete.php?id=<?= (int)$row['id'] ?>"
                  ...
                  <tr>
                    <td colspan="5" class="text-center py-4 text-muted">
                      ...
                      Belum ada data riset yang terdaftar.
                    </td>
                  </tr>
                <?php endif; ?>
