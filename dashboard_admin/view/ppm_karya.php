...
// Ambil data PPM
if ($filter_dosen !== "") {
  $result = getPpmByDosen($conn, $filter_dosen);
} else {
  $result = getAllPpm($conn);
}
?>
...
<body>
  ...
  <div id="content" class="content">
    <div class="container-fluid p-3">
      ...
      <!-- ===================== JUDUL PAGE ===================== -->
      <h4 class="fw-bold mb-4 text">Manajemen PPM</h4>

      <!-- ===================== TAMBAH PPM ===================== -->
      <div class="card shadow-sm p-4 mb-5">
        <h5 class="fw-bold mb-3">Tambah Kegiatan PPM Baru</h5>

        <form action="../controller/add_ppm_action.php" method="POST">
          <div class="row g-3">
          ...
          <div class="text-end mt-4">
            <button type="submit" class="btn btn-primary">
              <i class="bi bi-plus-lg"></i> Tambah PPM
            </button>
          </div>
        </form>
      </div>
      ...
      <!-- ===================== FILTER + JUDUL LIST ===================== -->
      <h4 class="fw-bold mb-4 text">Daftar PPM</h4>
      <div class="card shadow-sm p-4 mb-4">
        ...
        <?php endif; ?>
        <!-- ===================== TABEL PPM ===================== -->
        <div class="card shadow-sm mtp-0">
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-sm btn-danger"
                          href="../controller/ppm_delete.php?id=<?= (int)$row['id'] ?>"
                          onclick="return confirm('Yakin ingin menghapus PPM ini?');">
                  ...
                  <tr>
                    <td colspan="5" class="text-center py-4 text-muted">
                      ...
                      Belum ada data PPM yang terdaftar.
                    </td>
                  </tr>
                <?php endif; ?>
